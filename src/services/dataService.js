...
export const expertise = [
    ...
    I’ll find the best way to convey it to make you make better business decisions.`
	},
	{
		id: 3,
		src: require('../assets/expertise/content writing.jpg'),
    ...
    I aim to promote and connect to your business to your target audience via digital channels which
